...
**Quick counts (current registry):** generated from the live registry; availability varies by enabled toolsets, platform, credentials, plugins, MCP servers, and dispatcher-spawned kanban context.
