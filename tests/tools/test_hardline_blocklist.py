...
_HARDLINE_BLOCK = [
    ...
    "nohup reboot",
    "setsid poweroff",
    # Owner approval token minting must not run through a model terminal.
    "hermes kanban boards contract approval-token launch-board",
    "python -m hermes_cli.main kanban boards contract approval-token launch-board",
]
